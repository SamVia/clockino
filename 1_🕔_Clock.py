...
"""
st_title = f"""
<div style="position: absolute; top: 10px; left: -300px; height: 100px; font-size: 35px; font-weight: bold; color: {st.session_state.color}">
    {date_to_print}
</div>
"""
print_m = f"""
    <div style="display: grid; place-items: center; height: 100%;">
        <div style="font-size: 100px; font-weight: bold; color: {st.session_state.color};">
            {time_to_print}
        </div>
    </div>
    """
